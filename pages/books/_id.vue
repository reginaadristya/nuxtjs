<template>
  <div>
    ...
    <v-text-field title="Relase Year" v-model="book.Title" :rules="[v => !!v || 'Relase Year is required']">
    </v-text-field>
    <v-text-field title="Length" v-model="book.Author" :rules="[v => !!v || 'Length is required']"></v-text-field>
    <v-text-field title="Synopsis" v-model="book.Author" :rules="[v => !!v || 'Synopsis is required']"></v-text-field>
    <v-btn @click="save">
      Save
    </v-btn>
    <v-btn @click="close">
